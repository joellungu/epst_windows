...
class _Affiche extends State<Affiche> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          child: ListTile(
            onTap: () async {
              ...
              if([
                ...
                player.add(Media.file(File("$tempDirectory/${mag['id']}.${mag['extention']}")));
                /*
                player.open(
                      ...
                      children: [
                        ...
                        Expanded(
                            child: Container(
                              ...
                              child: ExtendedImage.asset("$tempDirectory/${mag['id']}.${mag['extention']}"),
                            )
                        )
                      ],
                    ),
            ...
            leading: Icon(
              [
                ...
                "MKV",
                "MPEG-2"
              ].contains('${mag["extention"]}'.toUpperCase()) ? Icons.play_arrow_outlined : Icons.file_download_done,
              color: Colors.black,
            ),
            title: Text(
              "${mag["libelle"]}",
      ...
      ) : Center(child: Container(alignment: Alignment.center, height: 5, width: 100, child: LinearProgressIndicator(),),),
    );
  }
}
