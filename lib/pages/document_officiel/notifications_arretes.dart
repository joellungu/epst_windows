...
class NotificationsArretes extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _NotificationsArretes();
  }
}

class _NotificationsArretes extends State<NotificationsArretes> {
  Widget? vue;
  Widget? vue2;
  //
  RxString text = "".obs;
  ...
  Future<void> loadMagasin() async {
    ...
    plainteController.listePieceJointe.value = await Connexion.liste_magasin(6);
