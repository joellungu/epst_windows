...
class MessagePhonique extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _MessagePhonique();
  }
}

class _MessagePhonique extends State<MessagePhonique> {
  Widget? vue;
  Widget? vue2;
  //
  RxString text = "".obs;
  ...
  Future<void> loadMagasin() async {
    ...
    plainteController.listePieceJointe.value = await Connexion.liste_magasin(4);
