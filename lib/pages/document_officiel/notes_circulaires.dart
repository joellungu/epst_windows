...
class NotesCirculaire extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _NotesCirculaire();
  }
}

class _NotesCirculaire extends State<NotesCirculaire> {
  Widget? vue;
  Widget? vue2;
  //
  RxString text = "".obs;
  ...
  Future<void> loadMagasin() async {
    ...
    plainteController.listePieceJointe.value = await Connexion.liste_magasin(5);
